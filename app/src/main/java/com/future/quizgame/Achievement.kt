        ...
        if(data != null)
        {
            ...
            {   mediaPlayer= MediaPlayer.create(this,R.raw.win)
                ...
                else if (playerData.level==1)
                {
                    ...
                    binding.poet.text = "Precision mastered\n design refined \n Level Two is now behind\n The stars applaud \n your path is clear \n Onward \nbuilder \nto new frontiers! \n"
                }
                else if (playerData.level==2)
                {
                    ...
                    binding.poet.text = "The hill is conquered\n  the sword held high\n Your journey ends beneath the sky.\n Through every trial\n you rose\nyou fought\n A legend forged\n a story wrought.\n"
